            ...
            <div class="content" >
		     <h1 class="business_post_brd_title">
		    	...
		    	<span class="business_post_brd_date">
                   <tf:formatDateTime value="${ownerQuest.registeredAt}" pattern="yyyy.MM.dd"/>
                </span>
		    </h1>
		    <div class="business_post_brd_editor">
		<span><p class="business_post_brd_writer" style="float: left; " id="businessPostDetailWriter">글쓴이:</p> <p class="business_post_brd_nik" id="businessPostDetailNikname">${ownerQuest.ownerUser.name}</p></span>
