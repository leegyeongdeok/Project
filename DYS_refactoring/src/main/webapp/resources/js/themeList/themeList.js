...
function next() {
    ...
    if(searchParam == ""){
        location.href = nowPathName+"?rank=second";
    }else if(nowRankParam == ""){
        location.href = nowPathName +searchParam +"&rank=second";
    }else{
        location.href = nowPathName +searchParam.replace("first", "second");
    }
}
