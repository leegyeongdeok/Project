...
<div class="totalList">
	...
	<div class="themeTitle">
		<h1 class="main_title">Activity</h1>
	</div>
		...
		<div class="rankingList">
			<ul>
				...
				<c:if test="${nowRank == 'first'}">
					<c:forEach varStatus="status" var="actiRank" items="${activityRank}">
						<li onclick="detail(${actiRank.activityId})">
                        <span>
                            <img src="/resources/image/activity/${actiRank.activityId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${actiRank.name}</strong><br><br>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(actiRank.address,0 ,13)}..</strong><br><br>
                                <strong>종류:&nbsp;&nbsp;${actiRank.activityType}</strong><br><br>
                                <strong>전화:&nbsp;&nbsp;${actiRank.callNumber}</strong>
                            </p>
                        </span>
						</li>
					</c:forEach>
				...
				<c:if test="${nowRank == 'second'}">
					<c:forEach begin="5" varStatus="status" var="actiRank" items="${activityRank}">
						<li onclick="detail(${actiRank.activityId})">
                        <span>
                            <img src="/resources/image/activity/${actiRank.activityId}/main.PNG">
                            <p>
		...
		<div class="list">
			<ul>
				...
				<c:forEach varStatus="status" var="activity" items="${activityList.content}">
					<li onclick="detail(${activity.activityId})">
                        <span>
                            <img src="/resources/image/activity/${activity.activityId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${activity.name}</strong><br/><br/>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(activity.address,0 ,13)}..</strong><br/><br/>
                                <strong>종류:&nbsp;&nbsp;${activity.activityType}</strong><br/><br/>
