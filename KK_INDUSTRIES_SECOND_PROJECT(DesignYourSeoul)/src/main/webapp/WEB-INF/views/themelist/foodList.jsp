...
<div class="totalList">
    ...
    <div class="themeTitle">
        <h1 class="main_title">Restaurant</h1>
    </div>
        ...
        <div class="rankingList">
            <ul>
                ...
                <c:if test="${nowRank == 'first'}">--%>
                    <c:forEach varStatus="status" var="foodRank" items="${foodRank}">
                        <li id="item${status.count}" onclick="detail(${foodRank.famousRestaurantId})">
                        <span>
                            <img src="/resources/image/food/${foodRank.famousRestaurantId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${foodRank.name}</strong><br><br>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(foodRank.address,0 ,13)}..</strong><br><br>
                                <strong>종류:&nbsp;&nbsp;${foodRank.foodKind}</strong><br><br>
                                <strong>전화:&nbsp;&nbsp;${foodRank.callNumber}</strong>
                            </p>
                        </span>
                        </li>
                    </c:forEach>
               <%-- </c:if>--%>
                    <%--<c:forEach begin="5" varStatus="status" var="foodRank" items="${foodRank}">
                        <li onclick="detail(${foodRank.famousRestaurantId})">
                        <span>
                            <img src="/resources/image/food/${foodRank.famousRestaurantId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${foodRank.name}</strong><br><br>
        ...
        <div class="list">
            <ul>
                ...
                <c:forEach varStatus="status" var="food" items="${foodList.content}">
                    <li onclick="detail(${food.famousRestaurantId})">
                        <span>
                            <img src="/resources/image/food/${food.famousRestaurantId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${food.name}</strong><br/><br/>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(food.address,0 ,13)}..</strong><br/><br/>
                                <strong>종류:&nbsp;&nbsp;${food.foodKind}</strong><br/><br/>
