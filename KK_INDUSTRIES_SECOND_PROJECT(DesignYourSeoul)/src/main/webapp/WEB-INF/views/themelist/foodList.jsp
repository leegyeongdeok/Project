...
<script>
	...
	function detail(num) {
		location.href="foodDetail?no="+num+"&page="+nowPage+"&location="+$("#location_search").val();
	}

	function pageUp() {
		if(nowPage != totalP){
			nowPage++;
			location.href="foodList?+=&page="+nowPage+"&location="+$("#location_search").val();
		}else{
			alert("마지막 페이지입니다.");
		}
	...
	function pageSelect(page) {
		nowPage = page;
		location.href="foodList?page="+page+"&location="+$("#location_search").val();
	}
