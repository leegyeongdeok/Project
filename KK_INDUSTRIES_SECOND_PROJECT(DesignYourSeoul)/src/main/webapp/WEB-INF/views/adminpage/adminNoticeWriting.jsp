...
<body>
         ...
         <div class="post_detail_top">
            ...
            <div class="post_detail_bok">
               ...
               <div class="post_tit overlay">공 지 사 항 글 쓰 기</div>
      ...
      <!--post_detail_top-->
            ...
            <div class="content" >
		     <h1 class="post_brd_title">
		    	...
		    	<span class="post_detail_tbl_cell" id="businessInquiryWritingTblCell">
		    	 제 목 :
		    	 <input id="businessInquiryWritingTitle" class="post_writing_title" type="text"   placeholder="제목을 입력하세요">
		...
		<!-- <span><p class="post_brd_writer" style="float: left; ">글쓴이:</p> <p class="post_brd_nikname" >아무게</p></span> -->
		    ...
		    <div class="btn_area">
		    <input type="button" class="registration" value="등록" id="businessInquiryWritingRegistration" />
		    <input type="button" class="cancel" value="취소" id="businessInquiryWritingCancel" onclick="window.close()">		        		    
