...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <link rel="stylesheet" href="/resources/css/customerService/boardDetail.css">
</head>
<body>
...
<div class="content">
    <h1 class="board_tit">
        ...
        <span class="board_tit_date"><tf:formatDateTime value="${boardDetail.registeredAt}" pattern="yyyy.MM.dd"/></span>
    </h1>
                ...
                <c:forEach varStatus="status" var="reply" items="${replyList}">
                    <div class="listReviewItem__User">
                        <div class="reply_container">
                            <p class="review_nickName">${reply.nickname}</p>
                            <p class="review_date">
    ...
    <div class="btn_area">
        <input type="button" class="btn_back_list" value="목록" onclick="location.href='/dys/board'">
    </div>
</div>
