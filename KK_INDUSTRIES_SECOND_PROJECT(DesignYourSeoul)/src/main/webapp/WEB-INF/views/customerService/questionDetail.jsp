...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <link rel="stylesheet" href="/resources/css/customerService/questionDetail.css">
</head>
<body>
<script type="text/javascript" src="/resources/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="/resources/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="/resources/js/function/parameterController.js"></script>
<script type="text/javascript" src="/resources/js/cutomerService/questionDetail.js"></script>
...
<div class="content">
    ...
    <div class="business_inquiry_brd_editor">
        <span>
            <p class="business_inquiry_brd_name">글쓴이 : ${questionDetail.generalUser.nickname}</p>
        </span>
