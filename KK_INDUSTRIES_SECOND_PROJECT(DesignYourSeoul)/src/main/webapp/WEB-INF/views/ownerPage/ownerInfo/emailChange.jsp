...
<script type="text/javascript" src="/resources/js/ownerPage/ownerInfo/emailChange.js"></script>
            ...
            <div class="now_info_box">
                <div class="now_info">
                    <div class="change_box">
                        <input type="text" id="changeVal" value="" onblur="enableEmail()" placeholder="새로운 이메일주소"/>
                    </div>
                    <p class="error_next_box"></p>
