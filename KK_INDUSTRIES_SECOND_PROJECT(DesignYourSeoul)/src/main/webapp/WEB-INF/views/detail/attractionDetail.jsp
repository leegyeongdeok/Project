...
<div class="headerimage">
    ...
    <div class="image" id="img2">
        <img src="/resources/image/attraction/${attraction.attractionId}/1.PNG">
    </div>
    <div class="image" id="img3">
        <img src="/resources/image/attraction/${attraction.attractionId}/2.PNG">
    </div>
    <div class="image" id="img4">
        <img src="/resources/image/attraction/${attraction.attractionId}/3.PNG">
    </div>
    <div class="image" id="img5">
        <img src="/resources/image/attraction/${attraction.attractionId}/4.PNG">
    </div>
</div>
    ...
    <div class="space">
        ...
        <div class="left">
            <div class="inner">
              ...
              <p class="likecount">${attraction.recommend}</p>
              <button class="like" ></button>
              <button class="share" ></button>

              <h1  id="names" class="food_name" >${attraction.name}</h1>
