...
<div class="headerimage">
    <div class="image" id="img1">
        <img src="/resources/image/hotel/${hotel.accommodationId}/main.PNG">
    </div>
    <div class="image" id="img2">
        <img src="/resources/image/hotel/${hotel.accommodationId}/1.PNG">
    </div>
    <div class="image" id="img3">
        <img src="/resources/image/hotel/${hotel.accommodationId}/2.PNG">
    </div>
    <div class="image" id="img4">
        <img src="/resources/image/hotel/${hotel.accommodationId}/3.PNG">
    </div>
    <div class="image" id="img5">
        <img src="/resources/image/hotel/${hotel.accommodationId}/4.PNG">
    </div>
</div>
    ...
    <div class="space">
        ...
        <div class="left">
            <div class="inner">
              ...
              <p class="likecount">${hotel.recommend}</p>
              <button class="like" ></button>
              <button class="share" ></button>

              <h1  id="names" class="food_name" >${hotel.name}</h1>
