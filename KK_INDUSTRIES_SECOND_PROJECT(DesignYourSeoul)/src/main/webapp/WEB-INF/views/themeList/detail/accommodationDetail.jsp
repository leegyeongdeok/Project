...
<form id="data_form" style="display: none">
    ...
    <input type="hidden" class="theme_id" name="accommodation_id" value="${accommodation.accommodationId}">
</form>
    ...
    <div class="section">
        <div class="slide sd1 inputImage" data-anchor="slide1">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/accommodation/${accommodation.accommodationId}/main.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide2">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/accommodation/${accommodation.accommodationId}/1.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide3">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/accommodation/${accommodation.accommodationId}/2.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide4">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/accommodation/${accommodation.accommodationId}/3.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide5">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/accommodation/${accommodation.accommodationId}/4.PNG)">
            </div>
        </div>
        ...
        <div class="left">
            <div class="inner">
                ...
                <section class="list_detail">
                    <div class="title">
                        <div>
                            <span class="title">
                                 <p class="countLike">${accommodation.recommend}</p>
                                 <button class="like" onclick="like()"></button>
                                 <button class="share"></button>
                                <h1 id="names" class="list_name">${accommodation.name}</h1>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="inline">
                        <table class="listTable ">
                            ...
                            <tr>
                                <th>주소</th>
                                <td id="address">${accommodation.address}</td>
                            </tr>
                            <tr>
                                <th>전화번호</th>
                                <td>${accommodation.callNumber}</td>
                            </tr>
                            <tr>
                                <th>등급</th>
                                <td>
                                    <span>${accommodation.accommodationId}</span>
                                </td>
                            </tr>
                            <tr>
                                <th>링크</th>
                                <td> ${accommodation.link}</td>
                            </tr>
            ...
            <section class="listReviewList">
                ...
                <fieldset>
                    ...
                    <button id="search_btn" type="submit" title="검색" tabindex="3" class="sch_smit" onclick="createReview('accommodation')"><span class="blind">리뷰 달기</span>
                    </button>
