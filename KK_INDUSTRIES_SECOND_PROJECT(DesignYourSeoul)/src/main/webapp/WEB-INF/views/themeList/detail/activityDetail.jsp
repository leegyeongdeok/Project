...
<form id="data_form" style="display: none">
    ...
    <input type="hidden" class="theme_id" name="activity_id" value="${activity.activityId}">
</form>
    ...
    <div class="section">
        <div class="slide sd1 inputImage" data-anchor="slide1">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/activity/${activity.activityId}/main.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide2">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/activity/${activity.activityId}/1.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide3">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/activity/${activity.activityId}/2.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide4">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/activity/${activity.activityId}/3.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide5">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/activity/${activity.activityId}/4.PNG)">
            </div>
        </div>
        ...
        <div class="left">
            <div class="inner">
                ...
                <section class="list_detail">
                    <div class="title">
                        <div>
                            <span class="title">
                                 <p class="countLike">${activity.recommend}</p>
                                 <button class="like" onclick="like()"></button>
                                 <button class="share"></button>
                                <h1 id="names" class="list_name">${activity.name}</h1>
                            </span>
                        </div>
                    </div>
            ...
            <section class="listReviewList">
                ...
                <fieldset>
                    ...
                    <button id="search_btn" type="submit" title="검색" tabindex="3" class="sch_smit" onclick="createReview('activity')"><span class="blind">리뷰 달기</span>
                    </button>
