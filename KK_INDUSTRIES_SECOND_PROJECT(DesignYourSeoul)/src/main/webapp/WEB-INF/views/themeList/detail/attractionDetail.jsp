...
<form id="data_form" style="display: none">
    ...
    <input type="hidden" class="theme_id" name="attraction_id" value="${attraction.attractionId}">
</form>
    ...
    <div class="section">
        <div class="slide sd1 inputImage" data-anchor="slide1">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/attraction/${attraction.attractionId}/main.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide2">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/attraction/${attraction.attractionId}/1.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide3">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/attraction/${attraction.attractionId}/2.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide4">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/attraction/${attraction.attractionId}/3.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide5">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/attraction/${attraction.attractionId}/4.PNG)">
            </div>
        </div>
        ...
        <div class="left">
            <div class="inner">
                ...
                <section class="list_detail">
                    <div class="title">
                        <div>
                            <span class="title">
                                 <p class="countLike">${attraction.recommend}</p>
                                 <button class="like" onclick="like()"></button>
                                 <button class="share"></button>
                                <h1 id="names" class="list_name">${attraction.name}</h1>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="inline">
                        <table class="listTable ">
                            ...
                            <tr>
                                <th>주소</th>
                                <td id="address">${attraction.address}</td>
                            </tr>
                            <tr>
                                <th>전화번호</th>
                            ...
                            <tr>
                                <th>종류</th>
                                <td>
                                    <span>${attraction.attractionType}</span>
                                </td>
                            </tr>
                            <tr>
                                <th>링크</th>
            ...
            <section class="listReviewList">
                ...
                <fieldset>
                    ...
                    <button id="search_btn" type="submit" title="검색" tabindex="3" class="sch_smit" onclick="createReview('attraction')"><span class="blind">리뷰 달기</span>
                    </button>
