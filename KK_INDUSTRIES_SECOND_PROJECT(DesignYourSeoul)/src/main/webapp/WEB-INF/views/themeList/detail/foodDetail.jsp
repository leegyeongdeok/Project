...
<form id="data_form" style="display: none">
    ...
    <input type="hidden" class="theme_id" name="famous_restaurant_id" value="${restaurant.famousRestaurantId}">
</form>
    ...
    <div class="section">
        <div class="slide sd1 inputImage" data-anchor="slide1">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/food/${restaurant.famousRestaurantId}/main.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide2">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/food/${restaurant.famousRestaurantId}/1.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide3">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/food/${restaurant.famousRestaurantId}/2.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide4">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/food/${restaurant.famousRestaurantId}/3.PNG)">
            </div>
        </div>

        <div class="slide sd1 inputImage" data-anchor="slide5">
            <div class="slide_cotent"
                 style="background-image: url(/resources/image/food/${restaurant.famousRestaurantId}/4.PNG)">
            </div>
        </div>
        ...
        <div class="left">
            <div class="inner">
                ...
                <section class="list_detail">
                    <div class="title">
                        <div>
                            <span class="title">
                                 <p class="countLike">${restaurant.recommend}</p>
                                 <button class="like" onclick="like()"></button>
                                 <button class="share"></button>
                                <h1 id="names" class="list_name">${restaurant.name}</h1>
                            </span>
                        </div>
                    </div>
            ...
            <section class="listReviewList">
                <div class="listReviewList__Header">
                    <h2 class="listReviewList__Title">리뷰 ( ${reviewList.size()} )</h2>
                </div>

                <fieldset>
                    <span class="review_bar">
                        <input id="query" name="query" type="text" placeholder="리뷰를 입력 해주세요." maxlength="255"
                               class="input_text">
                    </span>

                    <button id="search_btn" type="submit" title="검색" tabindex="3" class="sch_smit"
                            onclick="createReview('food')"><span class="blind">리뷰 달기</span>
                    </button>
                </fieldset>
