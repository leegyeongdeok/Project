...
<div class="totalList">
	...
	<div class="themeTitle">
		<h1 class="main_title">Accommodation</h1>
	</div>
		...
		<div class="rankingList">
			<ul>
				...
				<c:if test="${nowRank == 'first'}">
					<c:forEach varStatus="status" var="accomRank" items="${accomRank}">
						<li onclick="detail(${accomRank.accommodationId})">
                        <span>
                            <img src="/resources/image/accommodation/${accomRank.accommodationId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${accomRank.name}</strong><br><br>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(accomRank.address,0 ,13)}..</strong><br><br>
                                <strong>종류:&nbsp;&nbsp;${accomRank.grade}</strong><br><br>
                                <strong>전화:&nbsp;&nbsp;${accomRank.callNumber}</strong>
                            </p>
                        </span>
						</li>
					</c:forEach>
				...
				<c:if test="${nowRank == 'second'}">
					<c:forEach begin="5" varStatus="status" var="accomRank" items="${accomRank}">
						<li onclick="detail(${accomRank.accommodationId})">
                        <span>
                            <img src="/resources/image/accommodation/${accomRank.accommodationId}/main.PNG">
                            <p>
	...
	<div class="otherList">
		...
		<div class="list">
			<ul>
				...
				<c:forEach varStatus="status" var="accom" items="${accomList.content}">
					<li onclick="detail(${accom.accommodationId})">
                        <span>
                            <img src="/resources/image/accommodation/${accom.accommodationId}/main.PNG">
                            <p>
                                <strong>상호:&nbsp;&nbsp;${accom.name}</strong><br/><br/>
                                <strong>주소:&nbsp;&nbsp;${fn:substring(accom.address,0 ,13)}..</strong><br/><br/>
                                <strong>성급:&nbsp;&nbsp;${accom.grade}</strong><br/><br/>
                                <strong>전화:&nbsp;&nbsp;${accom.callNumber}</strong>
                            </p>
                         </span>
					</li>
				</c:forEach>
			...
			<div class="btn">
				...
				<c:set var="nowPage" value="${accomList.number+1}"/>
				<c:set var="finalPage" value="${accomList.totalPages}"/>
