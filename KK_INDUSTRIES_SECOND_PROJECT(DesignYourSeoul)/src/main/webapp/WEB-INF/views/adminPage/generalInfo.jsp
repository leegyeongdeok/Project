...
<head>
    ...
    <title>GeneralUser Information</title>
    ...
    <div class="userInfo_content">
        ...
        <div class="basic_info">
            ...
            <div class="content">
                ...
                <div class="content_val">${generalUser.account}</div>
            </div>

            <div class="content">
                <strong class="content_tit">비밀번호</strong>
                <div class="content_val">${generalUser.password.replaceAll(".", "●")}</div>
            </div>

            <div class="content">
                <strong class="content_tit">닉네임</strong>
                <div class="content_val">${generalUser.nickname}</div>
            </div>

            <div class="content">
                <strong class="content_tit">이름</strong>
                <div class="content_val">${generalUser.name}</div>
            </div>

            <div class="content">
                <strong class="content_tit">생년월일</strong>
                <div class="content_val">${generalUser.birth}</div>
            </div>
        </div>
        <div id="second_info">
            <div class="basic_info second">
                ...
                <div class="content email_basic">
                    ...
                    <div class="content_val">${generalUser.email}</div>
                </div>
                <div class="content phone_basic">
                    <strong class="content_tit">번호</strong>
                    <div class="content_val">${generalUser.phoneNum}</div>
                </div>
        ...
        <div class="btn_area">
            <input type="button" class="delete" value="상태 변경" onclick="userBanned('${generalUser.account}')">
