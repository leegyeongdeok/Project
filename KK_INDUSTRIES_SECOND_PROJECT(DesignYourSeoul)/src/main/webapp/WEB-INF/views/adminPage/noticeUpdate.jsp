...
<div class="content">
	<h1 class="post_brd_title">
        <span class="post_detail_tbl_cell">
            제 목 :
            <input id="titleArea" class="post_writing_title" type="text" placeholder="제목을 입력하세요" value="${notice.title}">
        </span>
	</h1>
	...
	<div class="post_brd_editor">
		<form action="./insertBoard.do" method="post" id="insertQuestionFrm" enctype="multipart/form-data">
			...
			<textarea name="content" id="content_textArea">${notice.content}</textarea>
		</form>
	</div>

	<div class="btn_area">
		<input id="btn_update" type="button" class="registration" value="수정"/>
