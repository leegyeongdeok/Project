...
<%@ include file="../include/header.jsp"%>
	<div id="wrap">
		...
		<div id="header" class="join_membership" role="banner">
			<h1>
				<a href="#" class="h_logo"><span class="blind">DYS</span></a>
			</h1>
		</div>
		<!-- // header -->
					...
					<div class="join_content">
						...
						<div class="row_group">
							...
							<div class="join_row">
								...
								<!-- 아이디 입력란 --> 
								<input onblur="duplieId()" type="text" id="general_id" name="account" class="int" title="ID"
									maxlength="20">
						...
						<div class="row_group">
							...
							<div class="join_row">
								...
								<!-- 닉네임 입력란 --> 
								<input onblur="duplieNick()" type="text" id="nickname" name="nickname" title="닉네임" class="int"
									maxlength="40">
								</span>
						...
						<div class="join_row join_mobile" id="mobDiv">
							...
							<div class="ps_box country_code">
								...
								<!-- 전화 국번 선택란 -->
								<select id="nationNo" class="sel" aria-label="전화번호 입력">
							...
							<div class="int_mobile_area">
								...
								<!-- 전화 번호 입력란 --> 
								<input onblur="enablePhone()" type="tel" id="phoneNo" name="phone_num" placeholder="전화번호 입력"
		...
		<script>
			...
			function json(){
				...
				$.ajax({
					url : '/api/generalUser/create',
					type : "POST",
					contentType:'application/json',
					dataType : 'json',
					data : JSON.stringify(form),
					success : function(data){
						location.href='signUpSuccess'+'?name='+$("#name").val();
					...
					$.ajax({
						...
						success : function(data){
							...
							if(result == "중복된 닉네임입니다. 다른 닉네임을 사용하세요"){
								...
								enableChckerNick = false;
							}else{
								$("#nicknameMsg").get(0).style.color = "green";
								enableChckerNick = true;
							}
