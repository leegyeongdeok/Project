...
<div id="header" role="banner">
    <h1><a href="#" class="h_logo"><span class="blind">DYS</span></a></h1>
</div>
<!-- //header -->
<!-- container -->
                ...
                <form id="join_form" >
                    ...
                    <div class="terms_p">
                        ...
                        <span class="input_chk">
                           ...
                           <label for="chk_all"><span class="chk_all_txt">이용약관, 개인정보 수집 및 이용,<br class='m_br'> 위치정보 이용약관(선택),<br> 프로모션 안내<br class='m_br'> 메일 수신(선택)에 모두 동의합니다.</span></label>
                              </span>
                        </p>
                        <!-- 약관 내용 리스트 -->
...
<div class="article">
    ...
    <p class="article__text">
        DYS 서비스를 이용하시거나 DYS 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로,
...
<div class="article">
    ...
    <p class="article__text">
    DYS는 <a href="#" target="_blank">DYS</a>을 비롯한 DYS 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)을 통해 정보 검색,
        ...
        개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, <a href="#" target="_blank">DYS 웹고객센터(이하 ‘고객센터’)</a> 도움말 등에서 쉽게 확인하실 수 있습니다.
    </p>
    <p class="article__text">
    ...
    <p class="article__text">
    DYS 서비스에는 기본적으로 본 약관이 적용됩니다만 DYS가 다양한 서비스를 제공하는 과정에서 부득이 본 약관 외 별도의 약관, 운영정책 등을 적용하는 경우(예, DYS페이, V LIVE 등)가 있습니다.
        그리고 DYS 계열사가 제공하는 특정 서비스의 경우에도(예, LINE, SNOW등) 해당 운영 회사가 정한 고유의 약관, 운영정책 등이 적용될 수 있습니다.
...
<div class="article">
    ...
    <p class="article__text">
        ...
        계정이란 회원이 DYS 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로 관리하기 위해 설정한 회원 식별 단위를 말합니다.
        회원은 자신의 계정을 통해 좀더 다양한 DYS 서비스를 보다 편리하게 이용할 수 있습니다.
        이와 관련한 상세한 내용은 <em>계정 운영정책</em> 및 고객센터 내 <a href="#" target="_blank">DYS 회원가입 방법</a> 등에서 확인해 주세요.
    </p>
    <p class="article__text">
    ...
    <p class="article__text">
        ...
        고객센터 내 <a href="#" target="_blank">DYS 단체회원(단체 아이디) 소개</a> 등에서 확인해 주시기 바랍니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.</h3>
    <p class="article__text">
        DYS는 여러분이 게재한 게시물이 DYS 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱 풍요롭게 해줄 것을 기대합니다.
        게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 DYS 서비스 상에 게재한 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
    ...
    <p class="article__text">
        한편, DYS 서비스를 통해 여러분이 게재한 게시물을 적법하게 제공하려면 해당 콘텐츠에 대한 저장, 복제, 수정, 공중 송신, 전시, 배포,
    ...
    <p class="article__text">
        DYS는 여러분이 부여해 주신 콘텐츠 이용 권한을 저작권법 등 관련 법령에서 정하는 바에 따라 DYS 서비스 내 노출, 서비스 홍보를 위한 활용,
    ...
    <p class="article__text">
        또한 여러분이 제공한 소중한 콘텐츠는 DYS 서비스를 개선하고 새로운 DYS 서비스를 제공하기 위해 인공지능 분야 기술 등의 연구 개발 목적으로 DYS 및 DYS 계열사에서 사용될 수 있습니다.
        DYS는 지속적인 연구 개발을 통해 여러분께 좀 더 편리하고 유용한 서비스를 제공해 드릴 수 있도록 최선을 다하겠습니다.
    </p>
    <p class="article__text">
        DYS는 여러분이 자신이 제공한 콘텐츠에 대한 DYS 또는 다른 이용자들의 이용 또는 접근을 보다 쉽게 관리할 수 있도록 다양한 수단을 제공하기 위해 노력하고 있습니다.
        여러분은 DYS 서비스 내에 콘텐츠 삭제, 비공개 등의 관리기능이 제공되는 경우 이를 통해 직접 타인의 이용 또는 접근을 통제할 수 있고,
...
<div class="article">
    ...
    <p class="article__text">
        DYS는 서비스의 원활한 제공을 위하여 회원이 동의한 목적과 범위 내에서만 개인정보를 수집∙이용하며, 개인정보 보호 관련 법령에 따라 안전하게 관리합니다.
        DYS가 이용자 및 회원에 대해 관련 개인정보를 안전하게 처리하기 위하여 기울이는 노력이나
        기타 상세한 사항은 <a href="#" target="_blank">개인정보 처리방침</a>에서 확인하실 수 있습니다.
    </p>
    <p class="article__text">
        DYS는 여러분이 서비스를 이용하기 위해 일정 기간 동안 로그인 혹은 접속한 기록이 없는 경우, 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 사전에 안내해 드린 후 여러분의 정보를 파기하거나 분리 보관할 수 있으며,
...
<div class="article">
    ...
    <p class="article__text">
        ...
        보다 상세한 내용 및 절차는 고객센터 내 <a href="#" target="_blank">게시중단요청서비스 소개</a>를 참고해 주세요.
    </p>
    <p class="article__text">
        한편, DYS 서비스를 통해 타인의 콘텐츠를 이용한다고 하여 여러분이 해당 콘텐츠에 대한 지식재산권을 보유하게 되는 것은 아닙니다.
        여러분이 해당 콘텐츠를 자유롭게 이용하기 위해서는 그 이용이 저작권법 등 관련 법률에 따라 허용되는 범위 내에 있거나,
        해당 콘텐츠의 지식재산권자로부터 별도의 이용 허락을 받아야 하므로 각별한 주의가 필요합니다.
    </p>
    <p class="article__text">
        DYS는 여러분이 DYS 서비스를 마음껏 이용할 수 있도록 여러분께 DYS 서비스에 수반되는 관련 소프트웨어 사용에 관한 이용 권한을 부여합니다.
        이 경우 여러분의 자유로운 이용은 DYS가 제시하는 이용 조건에 부합하는 범위 내에서만 허용되고, 이러한 권한은 양도가 불가능하며,
...
<div class="article">
    ...
    <p class="article__text">
        ...
        포인트는 여러분의 일정한 DYS 서비스 이용과 연동하여 DYS가 임의로 책정하거나 조정하여 지급하는 일정한 계산 단위를 갖는 서비스 상의
    ...
    <p class="article__text">
        ...
        그리고 포인트는 DYS가 정한 기간에 따라 주기적으로 소멸할 수도 있으니 포인트가 부여되는 DYS 서비스 이용 시 유의해 주시기 바랍니다.
    </p>
</div>
<div class="article">
    ...
    <ul class="article__text">
        ...
        <li class="article__text__list">
            자동화된 수단을 활용하는 등 DYS 서비스의 기능을 비정상적으로 이용하여 게재된 게시물, DYS 각 개별 서비스의 제공 취지와
            부합하지 않는 내용의 게시물은 다른 이용자들의 정상적인 DYS 서비스 이용에 불편을 초래하고 더 나아가 DYS의 원활한 서비스 제공을 방해하므로 역시 제한될 수 있습니다.
        ...
        <li class="article__text__list">
            ...
            혹은 그 검색결과에서 특정 검색결과를 선택(이른바 ‘클릭’)하는 등 <span class="article__text">이용자(사람)의 실제 이용을 전제로 하는 DYS 서비스의 제공 취지에 부합하지 않는 방식으로
                                       DYS 서비스를 이용하거나 이와 같은 DYS 서비스에 대한 어뷰징(남용) 행위를 막기 위한 DYS의 기술적 조치를 무력화하려는 일체의 행위</span>(예: IP를 지속적으로 바꿔가며 접속하는 행위,
        ...
        <li class="article__text__list">
                                       ...
                                       구성된 각종 콘텐츠 자체 또는 파일을 삽입</span>해서는 안 됩니다. 또한, DYS 서비스 또는 이에 포함된 소프트웨어를 복사, 수정할 수 없으며,
            이를 판매, 양도, 대여 또는 담보로 제공하거나 타인에게 그 이용을 허락해서는 안 됩니다. DYS 서비스에 포함된 소프트웨어를 역 설계, 소스코드 추출 시도,
            복제, 분해, 모방, 기타 변형하는 등의 행위도 금지됩니다(다만, 오픈소스에 해당되는 경우 그 자체 조건에 따릅니다).
            <span class="article__text">그 밖에 바이러스나 기타 악성 코드를 업로드하거나 DYS 서비스의 원활한 운영을 방해할 목적으로 서비스 기능을 비정상적으로 이용하는 행위</span> 역시 금지됩니다.
        </li>
    </ul>
    <p class="article__text">
        DYS는 본 약관의 범위 내에서 게시물 운영정책, 각 개별 서비스에서의 약관 또는 운영정책, 각 서비스 상의 안내, 공지사항, 고객센터 도움말 등을 두어,
...
<div class="article">
    ...
    <p class="article__text">
        DYS는 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, 여러분이 게재한 게시물이 관련 법령, 본 약관, 게시물 운영정책,
    ...
    <p class="article__text">
        ...
        한편, 이러한 이용 제한에도 불구하고 더 이상 DYS 서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔 부득이 여러분과의 이용계약을 해지할 수 있습니다.
    </p>
    <p class="article__text">
...
<div class="article">
    ...
    <p class="article__text">
        DYS는 여러분이 DYS 서비스를 이용함에 있어 DYS의 고의 또는 과실로 인하여 손해를 입게 될 경우 관련 법령에 따라 여러분의 손해를 배상합니다.
        다만, 천재지변 또는 이에 준하는 불가항력으로 인하여 DYS가 서비스를 제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를 이용할 수 없어
...
<div class="article">
    ...
    <p class="article__text">
        DYS 서비스 이용계약이 해지되면, 관련 법령 및 개인정보처리방침에 따라 DYS가 해당 회원의 정보를 보유할 수 있는 경우를 제외하고,
...
<div class="article">
    ...
    <p class="article__text">
        DYS는 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만, 컴퓨터, 서버 등 정보통신설비의 보수점검,
        교체 또는 고장, 통신두절 등 운영상 상당한 이유가 있는 경우 부득이 서비스의 전부 또는 일부를 중단할 수 있습니다.
    </p>
    <p class="article__text">
        한편, DYS는 서비스 운영 또는 개선을 위해 상당한 필요성이 있는 경우 서비스의 전부 또는 일부를 수정, 변경 또는 종료할 수 있습니다.
        무료로 제공되는 서비스의 전부 또는 일부를 수정, 변경 또는 종료하게 된 경우 관련 법령에 특별한 규정이 없는 한 별도의 보상을 하지 않습니다.
    </p>
    <p class="article__text">
        이 경우 DYS는 예측 가능한 경우 상당기간 전에 이를 안내하며, 만약 예측 불가능한 경우라면 사후 지체 없이 상세히 설명하고 안내 드리겠습니다.
...
<div class="article">
    ...
    <p class="article__text">
        ...
        다만 회원 전체에 대한 통지가 필요할 경우엔 7일 이상 <a href="#" target="_blank">DYS</a>을 비롯한 DYS 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)
        초기 화면 또는 공지사항 등에 관련 내용을 게시하도록 하겠습니다.
    </p>
    <p class="article__text">
        DYS는 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 통해 서비스 이용과 관련된 의견이나 개선사항을 전달할 수 있으며,
...
<div class="article">
    ...
    <p class="article__text">
        DYS는 수시로 본 약관, 계정 및 게시물 운영정책을 개정할 수 있습니다만, 관련 법령을 위배하지 않는 범위 내에서 개정할 것이며,
    ...
    <p class="article__text">
        ...
        위 기간이 지나도록 여러분의 의견이 DYS에 접수되지 않으면, 여러분이 변경된 약관에 따라 서비스를 이용하는 데에 동의하는 것으로 간주됩니다.
        DYS로서는 매우 안타까운 일이지만, 여러분이 변경된 약관에 동의하지 않는 경우 변경된 약관의 적용을 받는 해당 서비스의 제공이 더 이상 불가능하게 될 수 있습니다.
    </p>
    <p class="article__text">
        DYS 서비스에는 기본적으로 본 약관이 적용됩니다만, 부득이 각 개별 서비스의 고유한 특성을 반영하기 위해 본 약관 외 별도의 약관,
    ...
    <p class="article__text">
        본 약관은 한국어를 정본으로 합니다. 본 약관 또는 DYS 서비스와 관련된 여러분과 DYS와의 관계에는 대한민국의 법령이 적용됩니다.
    ...
    <p class="article__text">
        DYS 서비스와 관련하여 궁금하신 사항이 있으시면 <a href="#" target="_blank">고객센터</a>(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
    </p>
</div>                                </div>
                            </li>
                            <li class="terms_bx">
                           ...
                           <span class="input_chk">
                              ...
                              <label for="termsPrivacy" class="collect_personal">개인정보 수집 및 이용에 대한 안내<span class="terms_necessary">(필수)</span></label>
                           </span>
                                <div class="terms_box" tabindex="0" id="divPrivacy">
                                    <!-- 개인정보 수집 및 이용에 대한 안내 -->
<div class="policy_summary">
    <p class="policy_summary__text">정보통신망법 규정에 따라 DYS에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
</div>
<div class="article">
    <h3 class="article__title">1. 수집하는 개인정보</h3>
    <p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 DYS 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, DYS는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
    <div class="clause">
        <h4 class="clause__title">회원가입 시점에 DYS가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
        <ul class="sections">
            <li class="sections__section">- 회원 가입 시에 ‘아이디, 비밀번호, 이름, 생년월일, 성별, 가입인증 휴대전화번호’를 필수항목으로 수집합니다. 만약 이용자가 입력하는 생년월일이 만14세 미만 아동일 경우에는 법정대리인 정보(법정대리인의 이름, 생년월일, 성별, 중복가입확인정보(DI), 휴대전화번호)를 추가로 수집합니다. 그리고 선택항목으로 이메일 주소를 수집합니다.</li>
            <li class="sections__section">- 단체아이디로 회원가입 시 단체아이디, 비밀번호, 단체이름, 이메일주소, 가입인증 휴대전화번호를 필수항목으로 수집합니다. 그리고 단체 대표자명을 선택항목으로 수집합니다.</li>
        </ul>
        <h4 class="clause__title">서비스 이용 과정에서 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
        <p class="clause__text">DYS 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
...
<div class="article">
    ...
    <p class="article__text">DYS 및 DYS 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</p>
    <ul class="sections">
        ...
        <li class="sections__section">- 법령 및 DYS 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.</li>
...
<div class="article">
    ...
    <div class="clause">
        ...
        <p class="clause__text">부정가입 및 징계기록 등의 부정이용기록은 부정 가입 및 이용 방지를 위하여 수집 시점으로부터 6개월간 보관하고 파기하고 있습니다. 부정이용기록 내 개인정보는 가입인증 휴대폰 번호(만 14세 미만 회원의 경우 법정대리인 DI)가 있습니다.<br>
            결제도용, 불법할인대출(일명 '카드깡') 등 관련 법령 및 이용약관을 위반하는 DYS페이의 부정거래기록(아이디, 이름, 휴대전화번호, 배송지 주소, IP주소, 쿠키, 기기정보)은 부정거래 방지 및 다른 선량한 이용자의 보호, 안전한 거래 환경 보장을 위하여 수집 시점으로부터 3년간 보관하고 파기합니다.<br>
            부정이용으로 징계를 받기 전에 회원 가입 및 탈퇴를 반복하며 서비스를 부정 이용하는 사례를 막기 위해 탈퇴한 이용자의 휴대전화번호를 복호화가 불가능한 일방향 암호화(해시 처리)하여 6개월간 보관합니다.
            QR코드 서비스에서 연락처를 등록한 이후 QR코드 삭제 시, 복구 요청 대응을 위해 삭제 시점으로 부터 6개월 보관합니다. 스마트 플레이스 서비스에서 휴대전화번호를 등록한 경우 분쟁 조정 및 고객문의 등을 목적으로 업체 등록/수정 요청시, 또는 등록 이후 업체 삭제 요청 시로부터 최대 1년간 보관 할 수 있습니다.
        </p>
    </div>
    <div class="clause">
        <h4 class="clause__title">전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. DYS는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.</h4>
        <ul class="sections">
        ...
        <p class="clause__text">회원탈퇴, 서비스 종료, 이용자에게 동의받은 개인정보 보유기간의 도래와 같이 개인정보의 수집 및 이용목적이 달성된 개인정보는 재생이 불가능한 방법으로 파기하고 있습니다.
            ...
            참고로 DYS는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
                           ...
                           <span class="input_chk">
                              ...
                              <label for="termsLocation">위치정보 이용약관 동의<span class="terms_choice terms_no">(선택)</span></label>
                                ...
                                <div class="terms_box" id="divLocation">
                                    <!-- 위치정보 이용약관 동의 -->
<div class="policy_summary">
                        <p class="policy_summary__text">위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하는 DYS 위치기반 서비스를 이용할 수 있습니다.</p><br>
                     </div>
                     <div class="article">
                        <h3 class="article__title">제 1 조 (목적)</h3>
                        <p class="article__text">이 약관은 DYS 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                     </div>
                     <div class="article">
                     ...
                     <div class="article">
                        ...
                        <ul class="sections">
                           ...
                           <li class="sections__section">주소: 경기도 성남시 분당구 불정로 6 DYS 그린팩토리 (463-867) </li>
                    ...
                    <div class="btn_area double">
                        <span><!-- tg-text=terms_button_cancel --><a onclick="checker('ownerUser')" id="btnOwner" class="btn_type btn_owner" role="button">업주회원</a></span>
                        <span><!-- tg-text=terms_button_agree --><a  onclick="checker('generalUser')" id="btnMember" class="btn_type btn_member" role="button">개인/일반</a></span>
                    </div>
                </form>
