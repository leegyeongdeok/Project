...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <link rel="stylesheet" href="/resources/css/ownerService/ownerNotice.css">
...
<script type="text/javascript" src="/resources/js/ownerService/ownerNotice.js"></script>
    ...
    <table class="business_noticetbl_board" id="businessNoticeBoard">
        ...
        <c:forEach var="notice" items="${generalNotice.content}">
            <tr>
                ...
                <td class="notice_num">${notice.noticeNo}</td>
