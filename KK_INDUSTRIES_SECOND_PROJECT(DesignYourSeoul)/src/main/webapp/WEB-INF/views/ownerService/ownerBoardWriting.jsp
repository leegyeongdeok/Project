...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <link rel="stylesheet" href="/resources/css/ownerService/ownerBoardWriting.css">
</head>
<body>
...
<script type="text/javascript" src="/resources/js/ownerService/ownerBoardWriting.js"></script>
...
<div class="content">
    ...
    <div class="post_brd_editor">
        <form action="./insertBoard.do" method="post" id="insertQuestionFrm" enctype="multipart/form-data">
            ...
            <input name="owner_id" id="userId" class="post_writing_title" type="hidden">
        </form>
    </div>
