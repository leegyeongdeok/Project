...
<script type="text/javascript" src="/resources/js/myPage/myInfo/nickNameChange.js"></script>
            ...
            <div class="now_info_box">
                <div class="now_info">
                    <div class="change_box">
                        <input onblur="enableNickName()" type="text" id="changeVal" value="" placeholder="새로운 닉네임">
                    </div>
