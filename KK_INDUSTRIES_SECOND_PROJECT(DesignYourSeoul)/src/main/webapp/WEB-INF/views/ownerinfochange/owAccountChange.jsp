...
<div class="info_change">
			...
			<div class="now_info_box">
				<div class="now_info">
					<div class="change_box">
						<input onblur="enableId()" type="text" id="account" placeholder="새로운 아이디">
	...
	<input type="hidden" id="oldAccount" value="<%=id%>">
	...
	<script>
		...
		function updateUser(){
				...
				$.ajax({
					url : '/api/ownerUser/update/account/'+old+'/'+id,
					type : "PUT",
					contentType:'application/json',
					success : function(data){
						alert('아이디가 변경되었습니다.');
						location.href="/dys/owner/Info?id="+id;
					},
