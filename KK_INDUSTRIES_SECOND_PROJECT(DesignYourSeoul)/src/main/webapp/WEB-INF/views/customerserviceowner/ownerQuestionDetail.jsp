		...
		<div class="content" >
			...
			<div class="business_inquiry_brd_editor">
				<span><p class="business_inquiry_brd_writer" id="businessInquiryDetailWriter" style="float: left;">글쓴이:</p>
					<p class="business_inquiry_brd_name" id="businessInquiryDetailName">${questionDetail.ownerUser.name}</p></span>
			...
			<table class="business_inquiry_tbl_pren" id="businessInquiryDetailTblPren">
				...
				<c:if test="${!empty beforeQuestion}">
					<tr>
						...
						<td>
							<a onclick="switchNotice(${beforeQuestion.ownerQuestionNo})" class="title_link">${beforeQuestion.title}</a>
						</td>
					</tr>
				</c:if>
				...
				<c:if test="${!empty afterQuestion}">
					<tr>
						...
						<td>
							<a onclick="switchNotice(${afterQuestion.ownerQuestionNo})" class="title_link">${afterQuestion.title}</a>
						</td>
					</tr>
				</c:if>
				</tbody>
...
<script>
	...
	function switchNotice(now) {
		location.href="QuestionDetail?no="+now+"&id="+account+"&name="+name+"&type="+type+"&page="+nowPage;
	}

	function listQuestion() {
		location.href = "/dys/Question?id="+id+"&name="+name+"&type="+type+"&page="+nowPage;
	}
