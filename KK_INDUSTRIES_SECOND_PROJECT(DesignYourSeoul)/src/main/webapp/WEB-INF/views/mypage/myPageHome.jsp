...
<head>
    ...
    <title>MyPage</title>
    <link rel="stylesheet" href="/resources/css/mypage/myPageHome.css">

</head>
<body>
<script type="text/javascript" src="/resources/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="/resources/js/jquery.serializeObject.js"></script>
<script type="text/javascript" src="/resources/js/myPage/myPageHome.js"></script>
        ...
        <div id="pageMain">
            ...
            <div class="content">
                ...
                <div class="head_content">
                    <h3 class="tit_personal"><span id="username"></span>님, 환영합니다.</h3>
                    <p class="title_font" id="title_p">
                        정보, 개인정보 보호 및 코스 계획을 관리하여 나에게 맞는 방식으로 DYS를 사용할 수 있습니다.
                    </p>
                </div>
