...
<div class="business_notice">
    ...
    <table class="business_noticetbl_board" id="businessNoticeBoard">
        ...
        <c:forEach var="notice" items="${generalNotice.content}">
            <tr>
...
<script>
    ...
    var nowPage = <%=pages%>;
    var totalP = ${generalNotice.totalPages};
    var type = $("#type").val();
    ...
    function pageUp() {
        if(nowPage != totalP){
            nowPage++;
            location.href="Notice?id="+account+"&name="+userName+"&type=general"+"&page="+nowPage;
        }else{
            alert("마지막 페이지입니다.");
        }
    ...
    function pageBack() {
        if(nowPage == totalP){
            ...
            nowPage = ${generalNotice.totalPages};
            location.href="Notice?id="+account+"&name="+userName+"&type=general"+"&page="+nowPage;
        }
    ...
    function pageSelect(page) {
        nowPage = page;
        location.href="Notice?id="+account+"&name="+userName+"&type=general"+"&page="+page;
    }

    function searchNotice(search) {
        var selectType = $("#type_selecter option:selected").val();
        location.href="Notice?id="+account+"&name="+userName+"&type=general"+"&search="+search+"&stype="+selectType;
    }
</script>
</body>
</html>