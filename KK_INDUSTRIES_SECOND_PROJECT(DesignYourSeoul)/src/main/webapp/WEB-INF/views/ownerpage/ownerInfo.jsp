...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/ownerPage/ownerPageInfo.css">

</head>
<body>
<script type="text/javascript" src="//code.jquery.com/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="/resources/js/jquery.serializeObject.js"></script>
<script type="text/javascript" src="/resources/js/ownerPage/ownerPageInfo.js"></script>
        ...
        <div id="pageMain">
            ...
            <div class="content">
                ...
                <div class="info_container first">
                    ...
                    <a href="/dys/owner/Info/passWord" class="change_info">
                    ...
                    <a href="/dys/owner/Info/name" class="change_info">
                    ...
                    <a href="/dys/owner/Info/birth" class="change_info">
                ...
                <div class="info_container second">
                    ...
                    <a href="/dys/owner/Info/email" class="change_info">
                    ...
                    <a href="/dys/owner/Info/phone" class="change_info">
