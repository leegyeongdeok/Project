...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/clothesDetail.css">
</head>

<body>
<script type="text/javascript" src="/resources/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="/resources/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="/resources/js/clothesDetail.js"></script>
...
<section id="second_sec" class="clothes_first_sec">
    ...
    <div class="content clothes_content">
        ...
        <div class="clothes_info_wrap">
            ...
            <input id="buy_clothes" type="button" onclick="wadiz()" value="구매하기">
        </div>
    </div>
    ...
    <div class="clothes_content_2">
        ...
        <div class="clothes_themeLogo">
            <div class="themeLogo_wrap">
                <i class="fa fa-angle-double-left fa-4x left_btn" onclick="imgEventClose()"></i>
                <img class="themeLogo" src="/resources/image/themeLogo/1st.jpg">
                <i class="fa fa-angle-double-right fa-4x img_eventer_up right_btn" onclick="imgEventOpen()"></i>
            </div>
        ...
        <div class="clothes_pattern" >
            ...
            <div class="detail_more_info_wrap" style="display: none" >
                ...
                <div class="clothes_sizeChart_wrap"><img class="clothes_sizeChart"
                                                         src="/resources/image/clothesPhoto/2019fw1/detailPhoto/fabric.jpg"></div>
                ...
                <div class="clothes_sizeChart_wrap"><img class="clothes_sizeChart"
                                                         src="/resources/image/clothesPhoto/2019fw1/detailPhoto/sewing.jpg"></div>
                ...
                <div class="clothes_sizeChart_wrap"><img class="clothes_sizeChart"
                                                         src="/resources/image/clothesPhoto/2019fw1/detailPhoto/printing.jpg"></div>
