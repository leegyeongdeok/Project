            ...
            <div class="box_leftType1">
                <ul class="list_thumType flnon">
                    <li class="bdr_nor"><div class="photo">
                        <a onclick="detail()"> <img src="/resources/image/courseranking/courseRank1.png"
                                                    alt="플렉스 서울투어">
                        </a>
                    </div>
                        <div class="area_txt">
