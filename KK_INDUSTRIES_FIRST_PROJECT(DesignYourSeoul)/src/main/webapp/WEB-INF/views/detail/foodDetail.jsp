...
<body >
   ...
   <div class="headerimage">
         <div class="image" id="img1">
            <img src="/resources/image/food/${restaurant.famousRestaurantId}/main.PNG">
         </div>
         <div class="image" id="img2">
             <img src="/resources/image/food/${restaurant.famousRestaurantId}/1.PNG">
         </div>
         <div class="image" id="img3">
            <img src="/resources/image/food/${restaurant.famousRestaurantId}/2.PNG">
         </div>
         <div class="image" id="img4">
             <img src="/resources/image/food/${restaurant.famousRestaurantId}/3.PNG">
         </div>
         <div class="image" id="img5">
             <img src="/resources/image/food/${restaurant.famousRestaurantId}/4.PNG">
         </div>
      </div>
...
<div class="space">
     ...
     <section class="food-detail">
            <header class="title">
              ...
              <p class="likecount">${restaurant.recommend}</p>
              <button class="like" ></button>
              <button class="share" ></button> 
          
              <h1  id="names" class="food_name" >${restaurant.name}</h1>
         ...
         <!--  리뷰 -->
          ...
          <header class="foodReviewList__Header">
             ...
             <span>(<span class="foodReviewList__AllCount"> 0</span> )</span></h2>
