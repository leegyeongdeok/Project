...
<div class="business_inquiry">
   ...
   <div class="business_inquirytable">
      <table id="businessInquiryTable" class="business_inquirytbl_board">
         ...
         <tbody>
         <c:forEach varStatus="status" var="question" items="${generalQuestion.content}">
            <tr>
               <td>${status.index+1}</td>
               <td>${question.generalUser.nickname}</td>
               <td>
                  <a class="title_link" onclick="detail(${question.generalQuestionNo})"> ${question.title}</a>
               </td>
               <td class="date">
   ...
   <div id="businessInquiryPaging" class="page">
      <ul>
         ...
         <c:forEach var="page" begin="1" end="${generalQuestion.totalPages}">
...
<script>
   ...
   var nowPage = <%=pages%>;
   var totalP = ${generalQuestion.totalPages};

   function detail(num) {
      location.href="QuestionDetail?no="+num+"&id="+account+"&name="+userName+"&type=general&page="+nowPage;
   }

   function pageUp() {
      if(nowPage != totalP){
         nowPage++;
         location.href="Question?id="+account+"&name="+userName+"&type=general"+"&page="+nowPage;
      }else{
         alert("마지막 페이지입니다.");
      }
   ...
   function pageBack() {
      if(nowPage == totalP){
         ...
         nowPage = ${generalQuestion.totalPages};
         location.href="Question?id="+account+"&name="+userName+"&type=general"+"&page="+nowPage;
      }
   ...
   function pageSelect(page) {
      nowPage = page;
      location.href="Question?id="+account+"&name="+userName+"&type=general"+"&page="+page;
   }

   function searchNotice(search) {
      var selectType = $("#type_selecter option:selected").val();
      location.href="Question?id="+account+"&name="+userName+"&type=general"+"&search="+search+"&stype="+selectType;
   }

   function writing() {
      location.href="QuestionWriting?id="+account+"&name="+userName+"&type=general";
   }
</script>
