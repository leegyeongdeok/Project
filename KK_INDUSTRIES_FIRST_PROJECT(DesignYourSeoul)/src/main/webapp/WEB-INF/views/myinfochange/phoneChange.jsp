            ...
            <div class="now_info_box">
                <div class="now_info">
                    ...
                    <div class="change_box">
                        <input type="text" id="phoneNumChange" value="" placeholder="새 번호">
                        <span class="error_next_box" id="phoneNumMsg" role="alert"></span>
                    </div>
                    <button
                            onclick="updatePhoneNum()" type="submit" class="change_button">완료
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function enablePhone() {
        phone = $("#phoneNumChange").val();


        enableChckerphone = true;
        var first = $("#phoneNumChange").val().substring(0,3);
        var all = $("#phoneNumChange").val();
    ...
    function updatePhoneNum(){
        ...
        if(nullPhone){
            alert("변경할 핸드폰번호를 입력해주세요.");
            return;
        }

        if(!check){
            alert("휴대폰 번호를 정확히 입력 해주세요.");
            return;
        }
