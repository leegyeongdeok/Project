                ...
                <div class="join_content">
                    ...
                    <div class="row_group">
                        ...
                        <div class="join_row">
                            ...
                            <span class="ps_box int_id">
								...
								<!-- 아이디 입력란 -->
								<input onblur="duplieId()" type="text" id="owner_id" name="account" class="int" title="ID"
                                       maxlength="20">
                    ...
                    <div class="join_row join_mobile" id="mobDiv">
                        ...
                        <div class="int_mobile_area">
								...
								<!-- 전화 번호 입력란 -->
								<input type="tel" id="phoneNo" name="phone_num" placeholder="전화번호 입력"
                        ...
                        <span class="error_next_box" id="phoneNoMsg"
                              style="display: none" role="alert">휴대전화 번호를 정확히 입력해주세요.(- 제외, 11자)</span>
                        <span
